        ...
        <div className="min-h-screen bg-[#0A0B0D] flex flex-col items-center justify-center font-inter p-6">
            <div className="w-full max-w-[440px] flex flex-col items-center">
                ...
                <div className="w-full">
                    <h1 className="text-white text-[28px] md:text-[32px] font-semibold mb-3 text-center tracking-tight">
                        Create your account
                    </h1>
                    <p className="text-[#888A8F] text-[15px] mb-8 text-center px-4 leading-relaxed">
                    ...
                    <div className="space-y-3">
                        <button className="w-full bg-[#1A1B1F] text-white border border-[#2D2E33] rounded-full py-[14px] text-[16px] font-semibold hover:bg-[#2D2E33] transition-colors cursor-pointer flex items-center justify-center gap-3">
                            <svg width="20" height="20" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M5.84 14.09c-.26-.78-.35-1.53-.35-2.25s.09-1.47.35-2.25V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z" fill="#FBBC05" />
                    ...
                    <p className="mt-8 text-[#888A8F] text-[12px] text-center leading-relaxed">
                        By creating an account, you agree to our <a href="#" className="hover:underline text-gray-400">User Agreement</a> and acknowledge that you have read our <a href="#" className="hover:underline text-gray-400">Privacy Policy</a> and <a href="#" className="hover:underline text-gray-400">Cookie Policy</a>.
                    </p>
                </div>
            </div>
        </div>
